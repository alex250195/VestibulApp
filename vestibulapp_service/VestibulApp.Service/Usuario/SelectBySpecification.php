<?php
	...
	$server->configureWSDL('server.selectBySpecificationUsuario', 'urn:server.selectBySpecificationUsuario');
	$server->wsdl->schemaTargetNamespace = 'urn:server.selectBySpecificationUsuario';
