...
public class UsuarioSelectVerifyThread extends AsyncTask<Object, Object, String> {

    private static final String SOAP_ACTION = "urn:server.selectVerify#selectVerify";
    private static final String METHOD_NAME = "selectVerify";
    private static final String NAMESPACE = "urn:server.selectVerify";
    private String URL = Constants.HOST + "Usuario/SelectVerify.php";
    ...
    public UsuarioSelectVerifyThread(Context _context){
