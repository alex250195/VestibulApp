...
public class CursoSelectBySpecification extends AsyncTask<Object, Object, String> {

    private static final String SOAP_ACTION = "urn:server.selectBySpecificationCurso#selectBySpecificationCurso";
    private static final String METHOD_NAME = "selectBySpecificationCurso";
    private static final String NAMESPACE = "urn:server.selectBySpecificationCurso";
    private String URL = Constants.HOST + "Curso/SelectBySpecification.php";
    ...
    public CursoSelectBySpecification(Context _context){
